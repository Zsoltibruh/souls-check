...
final class Character extends ActiveRecord
{
    protected string $id;
    ...
    {
        return $this->hasOne(Game::class, ['id' => 'game_id'])->inverseOf('characters');
    }
    ...
    {
        return $this->hasMany(Tasklist::class, ['character_id' => 'id'])->inverseOf('character');
    }
}
